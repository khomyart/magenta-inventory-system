<template>
  <div class="page">
    <div class="toolbar row q-px-md q-mt-md">
      ...
      <CreateSizeComponent v-if="allowenses.create" />
      <q-btn
        flat
        round
        color="black"
    ...
    <q-dialog v-model="sectionStore.dialogs.delete.isShown">
      <q-card>
        ...
        <q-card-section style="width: 350px">
          Ви справді бажаєте знищити розмір: "{{ deletedItem.value }}"?
        </q-card-section>
        <q-separator></q-separator>
        <q-card-actions align="right">
          <q-btn flat color="black" v-close-popup><b>Відміна</b></q-btn>
...
import SizeComponent from "src/components/size/SizeComponent.vue";
import CreateSizeComponent from "src/components/size/CreateSizeComponent.vue";
