    ...
    private function validateInvolvementLevels($level1UserId, $level2UserId, $level3UserId): array
    {
        ...
        if ($level1UserId !== null) {
            if ($level2UserId !== null || $level3UserId !== null) {
                return [
                    'valid' => false,
                    'message' => 'Якщо вказано користувача з повною залученістю (11%), не можна вказувати користувачів з частковою (8%) або дотичною (5%) залученістю',
                ];
            }
        }
        ...
        if (($level2UserId !== null || $level3UserId !== null) && $level1UserId !== null) {
            return [
                'valid' => false,
                'message' => 'Якщо вказано користувачів з частковою (8%) або дотичною (5%) залученістю, не можна вказувати користувача з повною залученістю (11%)',
            ];
        }
